...
- [kodbox: 私人云盘](https://github.com/kalcaddle/kodbox)

- [cloudreve/cloudreve: 🌩 Self-hosted file management and sharing system, supports multiple storage providers](https://github.com/cloudreve/cloudreve)
...
- [astro: 博客](https://github.com/withastro/astro)
...
- [emdash: EmDash is a full-stack TypeScript CMS based on Astro; the spiritual successor to WordPress](https://github.com/emdash-cms/emdash)
...
- [situation-monitor: Real-time dashboard for monitoring global news, markets, and geopolitical events](https://github.com/hipcityreg/situation-monitor)
...
- [worldmonitor: 实时全球情报监控](https://github.com/koala73/worldmonitor)
...
- [ChineseSubFinder: 自动化中文字幕下载。字幕网站支持 shooter、xunlei、arrst、a4k、SubtitleBest 。支持 Emby、Jellyfin、Plex、Sonarr、Radarr、TMM](https://github.com/ChineseSubFinder/ChineseSubFinder)
...
- [mediary-scout: 开源的搜剧 Agent，搜索各种资源，存入你的网盘](https://github.com/fancydirty/mediary-scout)
